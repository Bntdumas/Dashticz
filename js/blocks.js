				...
				blocks['settings']+= '<div class="row">';
					...
					blocks['settings']+= '<div class="col-md-5">';
						blocks['settings']+= '<select name="dashticz_language" class="form-control">';
							...
							if(_LANGUAGE=='fr_FR') blocks['settings']+= '<option value="fr_FR" selected>French</option>';
							else blocks['settings']+= '<option value="fr_FR">French</option>';
...
blocks['editblock']+= '</div>';
    ...
    blocks['coffee'] ='<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3" id="device8">';
    blocks['coffee']+='<div class="panel panel-default">';
        blocks['coffee']+='<div class="panel-heading">';
            blocks['coffee']+='<div class="row">';
                blocks['coffee']+='<div class="col-xs-8 text-left">';
                    blocks['coffee']+='<div class="huge">Coffee</div>';
                blocks['coffee']+='</div>';
                blocks['coffee']+='<div class="col-xs-4 text-right icon">';
                        blocks['coffee']+='<a href="javascript:togglePower();">';
                            blocks['coffee']+='<img src="apps/coffee/[COFFEE_STATUS_LOWER].png" height="55" width="55"/>';
                        blocks['coffee']+='</a>';
                blocks['coffee']+='</div>';
            blocks['coffee']+='</div>';
        blocks['coffee']+='</div>';
        blocks['coffee']+='<div class="panel-footer">';
            blocks['coffee']+='<span class="pull-left">';
                blocks['coffee']+='<a href="javascript:makeLargeCoffee();">';
                    blocks['coffee']+='<img src="apps/coffee/coffee_large.png" height="50" width="50"/>';
                blocks['coffee']+='</a>';
                blocks['coffee']+='<a href="javascript:makeSmallCoffee();">';
                    blocks['coffee']+='<img src="apps/coffee/coffee_small.png" height="50" width="50"/>';
                blocks['coffee']+='</a>';
            blocks['coffee']+='</span>';
        blocks['coffee']+='</div>';
    blocks['coffee']+='</div>';
